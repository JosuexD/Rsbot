package org.josue.dragonfiend.core;
...
import org.josue.dragonfiend.nodes.*;
...
@Manifest(authors = {"Josue"}, name = "Dragon Fiend", description = "Kills Black Dragons in Evil Chicken Lair")
public class DragonFiend extends ActiveScript implements PaintListener {
    ...
    public void onStart() {
        ...
        Variables.startxp = Skills.getExperience(Skills.STRENGTH);
    ...
    public void onRepaint(Graphics g) {
        ...
        g.drawString("Time ran: " + Time.format(System.currentTimeMillis() - Variables.startTime), 10, 70); // TIME RUNNING
        g.drawString("Strength XP: " + df.format((Skills.getExperience(Skills.STRENGTH) - Variables.startxp)), 10, 85); // EXPERIENCE GAINED
